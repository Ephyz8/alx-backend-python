...
class LIFOCache(BaseCaching):
    """
    LIFOCache class is a caching system that uses the LIFO (Last-In, First-Out)
    algorithm.
    """
    ...
    def put(self, key, item):
        ...
        # If the key is not already in cache_data, and adding it will exceed
        # MAX_ITEMS, evict the last item
